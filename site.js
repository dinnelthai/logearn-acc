(function(){
  ...
  if(file!=='index.html'){
    ...
    var related={
      ...
      'detail-page.html':[['signal-filter.html',isEn?'Signal Filters':'六大信号筛选'],['faq.html','FAQ'],['ai/strategies.html',isEn?'Choose a Strategy':'官方策略怎么选']],
      ...
      'ai-strategy.html':[['ai/strategies.html',isEn?'Choose a Strategy':'官方策略怎么选'],['ai/import.html',isEn?'Import a Strategy':'导入策略'],['ai/settings.html',isEn?'Strategy Settings':'策略设置']],
      ...
      'ai/strategies.html':[['ai/import.html',isEn?'Import a Strategy':'导入策略'],['ai/settings.html',isEn?'Strategy Settings':'策略设置'],['ai/cases.html',isEn?'Trading Cases':'实战案例']],
      'ai/suxing.html':[['ai/strategies.html','官方策略怎么选'],['detail-page.html#chip-distribution','筹码分析'],['recap.html','实战复盘']],
      'ai/notes.html':[['ai/settings.html','策略设置'],['ai/strategies.html','官方策略怎么选'],['ai/import.html','导入策略']],
      'ai/import.html':[['ai/strategies.html',isEn?'Choose a Strategy':'官方策略怎么选'],['ai/settings.html',isEn?'Strategy Settings':'策略设置'],['ai/logic.html',isEn?'Strategy Logic':'策略逻辑']],
